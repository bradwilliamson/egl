...
qBool	Pickup_Weapon (edict_t *ent, edict_t *other);
...
qBool Pickup_Powerup (edict_t *ent, edict_t *other)
{
	int		quantity;
...
qBool Pickup_Adrenaline (edict_t *ent, edict_t *other)
{
	if (!deathmatch->floatVal)
		other->max_health += 1;
...
qBool Pickup_AncientHead (edict_t *ent, edict_t *other)
{
	other->max_health += 2;
...
qBool Pickup_Bandolier (edict_t *ent, edict_t *other)
{
	gitem_t	*item;
	int		index;
...
qBool Pickup_Pack (edict_t *ent, edict_t *other)
{
	gitem_t	*item;
	int		index;
...
qBool Pickup_Key (edict_t *ent, edict_t *other)
{
	if (coop->floatVal)
	{
...
qBool Pickup_Ammo (edict_t *ent, edict_t *other)
{
	int			oldcount;
	int			count;
	qBool	weapon;
...
qBool Pickup_Health (edict_t *ent, edict_t *other)
{
...
qBool Pickup_Armor (edict_t *ent, edict_t *other)
{
	int				old_armor_index;
...
qBool Pickup_PowerArmor (edict_t *ent, edict_t *other)
{
	int		quantity;
...
static void drop_temp_touch (edict_t *ent, edict_t *other, cBspPlane_t *plane, cBspSurface_t *surf)
{
	if (other == ent->owner)
		return;
