...
=================
*/
void blaster_touch (edict_t *self, edict_t *other, cBspPlane_t *plane, cBspSurface_t *surf)
{
	int		mod;
...
void fire_blaster (edict_t *self, vec3_t start, vec3_t dir, int damage, int speed, int effect, qBool hyper)
{
	edict_t	*bolt;
	trace_t	tr;
...
static void Grenade_Touch (edict_t *ent, edict_t *other, cBspPlane_t *plane, cBspSurface_t *surf)
{
	if (other == ent->owner)
		return;
...
=================
*/
void rocket_touch (edict_t *ent, edict_t *other, cBspPlane_t *plane, cBspSurface_t *surf)
{
	vec3_t		origin;
	int			n;
...
void bfg_touch (edict_t *self, edict_t *other, cBspPlane_t *plane, cBspSurface_t *surf)
{
	if (other == self->owner)
		return;
