...
void gib_touch (edict_t *self, edict_t *other, cBspPlane_t *plane, cBspSurface_t *surf)
{
...
void path_corner_touch (edict_t *self, edict_t *other, cBspPlane_t *plane, cBspSurface_t *surf)
{
	vec3_t		v;
	edict_t		*next;
...
*/
void point_combat_touch (edict_t *self, edict_t *other, cBspPlane_t *plane, cBspSurface_t *surf)
{
	edict_t	*activator;
...
void func_object_touch (edict_t *self, edict_t *other, cBspPlane_t *plane, cBspSurface_t *surf)
{
...
void barrel_touch (edict_t *self, edict_t *other, cBspPlane_t *plane, cBspSurface_t *surf)
...
*/
void misc_viper_bomb_touch (edict_t *self, edict_t *other, cBspPlane_t *plane, cBspSurface_t *surf)
{
...
void teleporter_touch (edict_t *self, edict_t *other, cBspPlane_t *plane, cBspSurface_t *surf)
{
	edict_t		*dest;
	int			i;
